          ...
          <form role="form" action="<?php base_url('orders/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="date" class="col-sm-12 control-label">Data: <?php echo date('d-m-Y H:i') ?></label>
                </div>
                ...
                <div class="col-md-6 col-xs-12 pull pull-right">
                  ...
                  <div class="form-group">
                    <label for="gross_amount" class="col-sm-5 control-label">Total sem desconto</label>
                    <div class="col-sm-7">
                  ...
                  <div class="form-group">
                    <label for="vat_charge" class="col-sm-5 control-label">Taxa <?php echo $company_data['vat_charge_value'] ?> %</label>
                    <div class="col-sm-7">
                  ...
                  <div class="form-group">
                    <label for="net_amount" class="col-sm-5 control-label">Total com desconto</label>
                    <div class="col-sm-7">
                  ...
                  <div class="form-group">
                    <label for="paid_status" class="col-sm-5 control-label">Situação</label>
                    <div class="col-sm-7">
