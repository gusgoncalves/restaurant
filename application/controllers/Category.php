...
class Category extends Admin_Controller {
	public function __construct(){
		...
		$this->data['page_title'] = 'Categoria';
	...
	public function create(){
		...
		$this->form_validation->set_rules('category_name', 'Nome da Categoria', 'trim|required');
	...
	public function update($id)
	{
		...
		if($id) {
			$this->form_validation->set_rules('edit_category_name', 'Nome da Categoria', 'trim|required');
			...
			$response['success'] = false;
    		$response['messages'] = 'Por favor atualize a página novamente!!';
		}
